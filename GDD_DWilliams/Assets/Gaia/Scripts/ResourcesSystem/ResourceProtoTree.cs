    ...
    public class ResourceProtoTree
    {
        ...
        public bool AssociateAssets()
        {
            ...
            if (m_desktopPrefab == null)
            {
                if (!string.IsNullOrEmpty(m_desktopPrefabFileName))
                {
                    m_desktopPrefab = Gaia.Utils.GetAsset(m_desktopPrefabFileName, typeof(UnityEngine.GameObject)) as GameObject;
                    if (m_desktopPrefab != null)
                    {
                        isModified = true;
                    }
            ...
            if (m_mobilePrefab == null)
            {
                if (!string.IsNullOrEmpty(m_mobilePrefabFileName))
                {
                    m_mobilePrefab = Gaia.Utils.GetAsset(m_mobilePrefabFileName, typeof(UnityEngine.GameObject)) as GameObject;
                    if (m_mobilePrefab != null)
                    {
                        isModified = true;
                    }
